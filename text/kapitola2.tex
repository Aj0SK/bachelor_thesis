...
longer than 9 (long gaps). For each alignment, we count the number of gaps in these two groups.

\ref{obr:res_1} shows the ratio between the number of the gaps of given length divided
...
both positive and negative alignments that there are small gaps because due to the noise in the underlying signal.
Most of the time, the bigger gaps are a sign of the two
...
in the case of the positive squiggles and the difference between positive and negative
