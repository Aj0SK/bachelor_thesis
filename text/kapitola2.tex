...
of the index over the simulated reference squiggle that we can then use for fast searching
...
respectively. If $ls=w_1w_2\cdots w_n$ then $ls$ where the subsequent characters are substited
