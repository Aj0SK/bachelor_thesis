...
We already saw in Figure \ref{obr:simVsReal} that one of the biggest differences between simulated and
...
Now we will propose, how we will distinguish if the two squiggles are similar or not.
