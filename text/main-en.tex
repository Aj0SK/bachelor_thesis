...
The selective sequencing is very useful technology, allowed by the MinION sequencer,
that enables us to selectively sequence only the interesting DNA molecules. In some
scenarios, it can speed up the whole process of the DNA sequencing significantly.
However, there is not yet the real solution that could be able to use the full
...
we try to build good discretizing algorithm to allow easier work with the raw squiggles.
